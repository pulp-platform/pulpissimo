...
### Constraint File for the Nexys 4 board
...
## PMOD A as JTAG 
set_property -dict {PACKAGE_PIN B13 IOSTANDARD LVCMOS33} [get_ports pad_jtag_tms]
set_property -dict {PACKAGE_PIN F14 IOSTANDARD LVCMOS33} [get_ports pad_jtag_tdi]
set_property -dict {PACKAGE_PIN D17 IOSTANDARD LVCMOS33} [get_ports pad_jtag_tdo]
set_property -dict {PACKAGE_PIN E17 IOSTANDARD LVCMOS33} [get_ports pad_jtag_tck]

##PMOD B for I2C and I2S
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports pad_i2c0_sda] 
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports pad_i2c0_scl]

set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports pad_i2s0_sck]
set_property -dict { PACKAGE_PIN R16   IOSTANDARD LVCMOS33 } [get_ports pad_i2s0_ws]
set_property -dict { PACKAGE_PIN T9   IOSTANDARD LVCMOS33 } [get_ports pad_i2s0_sdi]
set_property -dict { PACKAGE_PIN U11   IOSTANDARD LVCMOS33 } [get_ports pad_i2s1_sdi]
...
## LEDs
set_property -dict {PACKAGE_PIN T8 IOSTANDARD LVCMOS33} [get_ports led0_o]
set_property -dict {PACKAGE_PIN V9 IOSTANDARD LVCMOS33} [get_ports led1_o]
set_property -dict {PACKAGE_PIN R8 IOSTANDARD LVCMOS33} [get_ports led2_o]
set_property -dict {PACKAGE_PIN T6 IOSTANDARD LVCMOS33} [get_ports led3_o]

## Switches
set_property -dict {PACKAGE_PIN U9 IOSTANDARD LVCMOS33} [get_ports switch0_i]
set_property -dict {PACKAGE_PIN U8 IOSTANDARD LVCMOS33} [get_ports switch1_i]
...
set_property -dict {PACKAGE_PIN K2 IOSTANDARD LVCMOS33} [get_ports pad_spim_csn0]
set_property -dict {PACKAGE_PIN E7 IOSTANDARD LVCMOS33} [get_ports pad_spim_sdio0]
set_property -dict {PACKAGE_PIN J3 IOSTANDARD LVCMOS33} [get_ports pad_spim_sdio1]
set_property -dict {PACKAGE_PIN J4 IOSTANDARD LVCMOS33} [get_ports pad_spim_sdio2]
set_property -dict {PACKAGE_PIN K1 IOSTANDARD LVCMOS33} [get_ports pad_spim_sdio3]
set_property -dict {PACKAGE_PIN E6 IOSTANDARD LVCMOS33} [get_ports pad_spim_sck]
