...
artefacts=[
  ["https://iis-artifactory.ee.ethz.ch/artifactory/release/CentOS_7/pulp/sdk/mainstream/7776c20fb990ad470b4f5edc14664747a7a65c1c/0/sdk.tar.bz2", "pkg/sdk/2020.01.01"],
  ["https://iis-artifactory.ee.ethz.ch/artifactory/release/CentOS_7/pulp/pulp_riscv_gcc/mainstream/1.0.16/0/pulp_riscv_gcc.tar.bz2", "pkg/pulp_riscv_gcc/1.0.16"]
]

exports=[
  ["PULP_SDK_HOME", "$PULP_PROJECT_HOME/pkg/sdk/2020.01.01"],
  ["PULP_SDK_INSTALL", "$PULP_SDK_HOME/install"],
  ["PULP_SDK_WS_INSTALL", "$PULP_SDK_HOME/install/ws"],
  ["PULP_RISCV_GCC_TOOLCHAIN_CI", "$PULP_PROJECT_HOME/pkg/pulp_riscv_gcc/1.0.16"],
  ["CROSS_COMPILE", "$PULP_PROJECT_HOME/pkg/pulp_riscv_gcc/1.0.16/bin/riscv32-unknown-elf-"],
