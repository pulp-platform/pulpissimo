...
`define ASSIGN_I2S0_PAD2SOC(load, driver) \
  assign load.master_sck_i = driver.master_sck_i; \
  assign load.master_ws_i = driver.master_ws_i; \
...
`define ASSIGN_I2S0_SOC2PAD(load, driver) \
  assign load.master_sck_o = driver.master_sck_o; \
  ...
  assign load.master_ws_o = driver.master_ws_o; \
