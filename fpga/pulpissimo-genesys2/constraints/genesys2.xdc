...
set_property -dict {PACKAGE_PIN V20 IOSTANDARD LVCMOS33} [get_ports {reset_led_o}]
set_property -dict {PACKAGE_PIN V26 IOSTANDARD LVCMOS33} [get_ports {soc_clk_o}]
set_property -dict {PACKAGE_PIN W24 IOSTANDARD LVCMOS33} [get_ports {per_clk_o}]
set_property -dict {PACKAGE_PIN W23 IOSTANDARD LVCMOS33} [get_ports {slow_clk_o}]
