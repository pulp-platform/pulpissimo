...
set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { pad_xtal_in }]; #IO_L12P_T1_MRCC_35 Sch=gclk[100]
create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports { pad_xtal_in }];

##Switches

set_property -dict { PACKAGE_PIN A8    IOSTANDARD LVCMOS33 } [get_ports { pad_bootsel }]; #IO_L12N_T1_MRCC_16 Sch=sw[0]
...
set_property -dict { PACKAGE_PIN D9    IOSTANDARD LVCMOS33 } [get_ports { pad_reset_n }]; #IO_L6N_T0_VREF_16 Sch=btn[0]
...
set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports { pad_jtag_tck }]; #IO_0_15 Sch=ja[1]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets pad_frame_i/padinst_jtag_tck/iobuf_i/O]
set_property -dict { PACKAGE_PIN B11   IOSTANDARD LVCMOS33 } [get_ports { pad_jtag_tdi }]; #IO_L4P_T0_15 Sch=ja[2]
set_property -dict { PACKAGE_PIN A11   IOSTANDARD LVCMOS33 } [get_ports { pad_jtag_tdo }]; #IO_L4N_T0_15 Sch=ja[3]
set_property -dict { PACKAGE_PIN D12   IOSTANDARD LVCMOS33 } [get_ports { pad_jtag_tms }]; #IO_L6P_T0_15 Sch=ja[4]
set_property -dict { PACKAGE_PIN D13   IOSTANDARD LVCMOS33 } [get_ports { pad_jtag_trst }]; #IO_L6N_T0_VREF_15 Sch=ja[7]
...
set_property -dict { PACKAGE_PIN F1    IOSTANDARD LVCMOS33 } [get_ports { pad_spim_sck }]; #IO_L18P_T2_35 Sch=ck_sck
...
set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS33 } [get_ports { pad_i2c0_scl }]; #IO_L9N_T1_DQS_AD3N_15 Sch=scl_pup
set_property -dict { PACKAGE_PIN A13   IOSTANDARD LVCMOS33 } [get_ports { pad_i2c0_sda }]; #IO_L9P_T1_DQS_AD3P_15 Sch=sda_pup
...
set_property -dict { PACKAGE_PIN L13   IOSTANDARD LVCMOS33 } [get_ports { pad_spim_csn0  }]; #IO_L6P_T0_FCS_B_14 Sch=qspi_cs
set_property -dict { PACKAGE_PIN K17   IOSTANDARD LVCMOS33 } [get_ports { pad_spim_sdio0 }]; #IO_L1P_T0_D00_MOSI_14 Sch=qspi_dq[0]
set_property -dict { PACKAGE_PIN K18   IOSTANDARD LVCMOS33 } [get_ports { pad_spim_sdio1 }]; #IO_L1N_T0_D01_DIN_14 Sch=qspi_dq[1]
set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS33 } [get_ports { pad_spim_sdio2 }]; #IO_L2P_T0_D02_14 Sch=qspi_dq[2]
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { pad_spim_sdio3 }]; #IO_L2N_T0_D03_14 Sch=qspi_dq[3]
