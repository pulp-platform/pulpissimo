...
build:
	...
	@make --no-print-directory -f $(mkfile_path)/ips/axi_mem_if.mk build
	...
	@make --no-print-directory -f $(mkfile_path)/ips/riscv_gate.mk build
...
lib:
	...
	@make --no-print-directory -f $(mkfile_path)/ips/axi_mem_if.mk lib
	...
	@make --no-print-directory -f $(mkfile_path)/ips/riscv_gate.mk lib
...
clean:
	...
	@make --no-print-directory -f $(mkfile_path)/ips/axi_mem_if.mk clean
	...
	@make --no-print-directory -f $(mkfile_path)/ips/riscv_gate.mk clean
