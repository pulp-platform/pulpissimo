...
if {[info exists ::env(VSIM_PATH)]} {
    ...
    eval exec >@stdout vopt +acc=mnpr -o vopt_tb tb_pulp -floatparameters+tb_pulp -suppress 2732 $VSIM_IP_LIBS $VSIM_RTL_LIBS -work work 
} else {
    eval exec >@stdout vopt +acc=mnpr -o vopt_pulp_chip pulp_chip $VSIM_IP_LIBS -suppress 2732 $VSIM_RTL_LIBS -work pulpissimo_lib
}
